...
files = glob.glob("6_Output_Cell_Measurement_converted/1/*_combine.csv")
files.sort()
...
pca_model.fit(df1.iloc[:,0:7])
df1_new = pd.DataFrame(pca_model.transform(df1.iloc[:,0:7]))
...
plt.xlabel("PC1")
plt.ylabel("PC2")
plt.title("PCA for FP1")
plt.savefig("PCA_for_FP1_all_weeks.png")
plt.close()
...
plt.legend()
plt.title("Area vs Circularity for FP1")
plt.savefig("Area_vs_Circularity_for_FP1_all_weeks.png")
plt.close()
...
plt.legend()
plt.title("Area vs Aspect_Ratio for FP1")
plt.savefig("Area_vs_Aspect_Ratio_for_FP1_all_weeks.png")
plt.close()
        ...
        if p != q:
            for i in range(0,len(weeks)):
                if weeks[i] == 0:
                    ...
                    plt.xlabel(p)
                    plt.ylabel(q)
                    plt.title("{} vs {} - Week {} vs Rest of the weeks for FP1".format(p,q,weeks[i]))
                    plt.savefig("{}_vs_{}_for_FP1_week_0.png".format(p,q))
                    plt.close()
                ...
                if weeks[i] == 8:
                    ...
                    plt.ylabel(q)
                    plt.title("{} vs {} - Week {} vs Rest of the weeks for FP1".format(p,q,weeks[i]))
                    plt.savefig("{}_vs_{}_for_FP1_week_8.png".format(p,q))
                    plt.close()
                ...
                if weeks[i] == 16:
                    ...
                    plt.ylabel(q)
                    plt.title("{} vs {} - Week {} vs Rest of the weeks for FP1".format(p,q,weeks[i]))
                    plt.savefig("{}_vs_{}_for_FP1_week_16.png".format(p,q))
                    plt.close()
                ...
                if weeks[i] == 24:
                    ...
                    plt.ylabel(q)
                    plt.title("{} vs {} - Week {} vs Rest of the weeks for FP1".format(p,q,weeks[i]))
                    plt.savefig("{}_vs_{}_for_FP1_week_24.png".format(p,q))
                    plt.close()
